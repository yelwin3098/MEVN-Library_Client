<template>
  <div>
    ...
    <div class="app-content-page">
      ...
      <div class="app-page-spinner" v-if="findLoading || findSettingsLoadnig" v-loading="findLoading || findSettingsLoadnig"></div>
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            ...
            @change="onReturnDateChange"
             placeholder type="datetime" v-model="model[fields.returnDate.name]"></el-date-picker>
          </el-col>
        </el-form-item>
...
import loanStatusTag from './loan-status-tag.vue';
...
export default {
  ...
  data() {
    ...
    if(!isEditing){
      const bookStockValidator=(rule,value,callback)=>{
        ...
        if(value.stock <= 0){
          callback(new Error(i18n('entities.loan.validation.bookOutOfStock')));
          return;
        }
        callback();
        return;
  ...
  computed: {
    ...mapGetters({
      ...
      findSettingsLoadnig:'settings/findLoading',
